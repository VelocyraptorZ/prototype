...
class Count extends Component
{
    ...
    public function mount()
    {
        ...
        //     {
        //         if(Auth::user()->can('View '.$status->name.' '.$type->name)){
        //             $this->statusCount[$type->name][$status->name] = Document::where('document_type_id', $type->id)
        //             ->where('status', $status->name)->count(); 
