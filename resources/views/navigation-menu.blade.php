    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('document.index',['type'=>'purchase-order']) }}" :active="request()->is('document/purchase-order')">
                        {{ __('Purchase Order') }}
                    </x-jet-nav-link>
                </div>
                @endcan
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('document.index',['type'=>'sales-quotation']) }}" :active="request()->is('document/sales-quotation')">
                        {{ __('Sales Quotation') }}
                    </x-jet-nav-link>
                </div>
                @endcan
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('document.index',['type'=>'sales-order']) }}" :active="request()->is('document/sales-order')">
                        {{ __('Sales Order') }}
                    </x-jet-nav-link>
                </div>
                @endcan
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('document.index',['type'=>'customer-invoice']) }}" :active="request()->is('document/customer-invoice')">
                ...
                @can('View Manifest')
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('manifest.index') }}" :active="request()->is('manifest.index')">
                        {{ __('Manifests') }}
                    </x-jet-nav-link>
                </div>
                @endcan
